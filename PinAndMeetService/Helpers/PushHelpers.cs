...
namespace PinAndMeetService.Helpers {
    public static class PushHelpers {
        ...
        //private const string APNS_PFX_CERTIFICATE_THUMBPRINT = "70957305702357034975233"; // See Azure Configuration page, PFX is just renamed P12 [Input here] meaning input in Azure
